...
MAX_SHORT_POSITION_SIZE = 1.8 / TOTAL_POSITIONS
MAX_LONG_POSITION_SIZE = 1.3 / TOTAL_POSITIONS
...
def make_pipeline():
    ...
    value_winsorized = value.winsorize(min_percentile=0.2, max_percentile=0.8)
    quality_winsorized = quality.winsorize(min_percentile=0.2, max_percentile=0.8)
    sentiment_score_winsorized = sentiment_score.winsorize(min_percentile=0.2,max_percentile=0.8)
    yesterday_close_winsorized = yesterday_close.winsorize(min_percentile=0.2,max_percentile=0.8)
    yesterday_volume_winsorized = yesterday_volume.winsorize(min_percentile=0.2,max_percentile=0.8)
    positive_sentiment_pct_winsorized = positive_sentiment_pct.winsorize(min_percentile=0.2,max_percentile=0.8)
